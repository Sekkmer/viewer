...
LLKeyboardSDL::LLKeyboardSDL()
{
    ...
    // Map letter and number scancodes to Linden KEY values
    for (int i = 0; i < 26; ++i)
    {
        mTranslateKeyMap[static_cast<U16>(SDL_SCANCODE_A + i)] = static_cast<KEY>('A' + i);
    }
    for (int i = 0; i <= 9; ++i)
    {
        mTranslateKeyMap[static_cast<U16>(SDL_SCANCODE_0 + i)] = static_cast<KEY>('0' + i);
    }
    ...
    mTranslateKeyMap[SDL_SCANCODE_SPACE] = static_cast<KEY>(' ');
    mTranslateKeyMap[SDL_SCANCODE_RETURN] = KEY_RETURN;
    mTranslateKeyMap[SDL_SCANCODE_LEFT] = KEY_LEFT;
    mTranslateKeyMap[SDL_SCANCODE_RIGHT] = KEY_RIGHT;
    mTranslateKeyMap[SDL_SCANCODE_UP] = KEY_UP;
    mTranslateKeyMap[SDL_SCANCODE_DOWN] = KEY_DOWN;
    mTranslateKeyMap[SDL_SCANCODE_KP_ENTER] = KEY_RETURN;
    mTranslateKeyMap[SDL_SCANCODE_ESCAPE] = KEY_ESCAPE;
    mTranslateKeyMap[SDL_SCANCODE_BACKSPACE] = KEY_BACKSPACE;
    mTranslateKeyMap[SDL_SCANCODE_DELETE] = KEY_DELETE;
    mTranslateKeyMap[SDL_SCANCODE_LSHIFT] = KEY_SHIFT;
    mTranslateKeyMap[SDL_SCANCODE_RSHIFT] = KEY_SHIFT;
    mTranslateKeyMap[SDL_SCANCODE_LCTRL] = KEY_CONTROL;
    mTranslateKeyMap[SDL_SCANCODE_RCTRL] = KEY_CONTROL;
    mTranslateKeyMap[SDL_SCANCODE_LALT] = KEY_ALT;
    mTranslateKeyMap[SDL_SCANCODE_RALT] = KEY_ALT;
    mTranslateKeyMap[SDL_SCANCODE_HOME] = KEY_HOME;
    mTranslateKeyMap[SDL_SCANCODE_END] = KEY_END;
    mTranslateKeyMap[SDL_SCANCODE_PAGEUP] = KEY_PAGE_UP;
    mTranslateKeyMap[SDL_SCANCODE_PAGEDOWN] = KEY_PAGE_DOWN;
    mTranslateKeyMap[SDL_SCANCODE_MINUS] = KEY_HYPHEN;
    mTranslateKeyMap[SDL_SCANCODE_EQUALS] = KEY_EQUALS;
    mTranslateKeyMap[SDL_SCANCODE_KP_EQUALS] = KEY_EQUALS;
    mTranslateKeyMap[SDL_SCANCODE_INSERT] = KEY_INSERT;
    mTranslateKeyMap[SDL_SCANCODE_CAPSLOCK] = KEY_CAPSLOCK;
    mTranslateKeyMap[SDL_SCANCODE_TAB] = KEY_TAB;
    mTranslateKeyMap[SDL_SCANCODE_KP_PLUS] = KEY_ADD;
    mTranslateKeyMap[SDL_SCANCODE_KP_MINUS] = KEY_SUBTRACT;
    mTranslateKeyMap[SDL_SCANCODE_KP_MULTIPLY] = KEY_MULTIPLY;
    mTranslateKeyMap[SDL_SCANCODE_KP_DIVIDE] = KEY_PAD_DIVIDE;
    mTranslateKeyMap[SDL_SCANCODE_F1] = KEY_F1;
    mTranslateKeyMap[SDL_SCANCODE_F2] = KEY_F2;
    mTranslateKeyMap[SDL_SCANCODE_F3] = KEY_F3;
    mTranslateKeyMap[SDL_SCANCODE_F4] = KEY_F4;
    mTranslateKeyMap[SDL_SCANCODE_F5] = KEY_F5;
    mTranslateKeyMap[SDL_SCANCODE_F6] = KEY_F6;
    mTranslateKeyMap[SDL_SCANCODE_F7] = KEY_F7;
    mTranslateKeyMap[SDL_SCANCODE_F8] = KEY_F8;
    mTranslateKeyMap[SDL_SCANCODE_F9] = KEY_F9;
    mTranslateKeyMap[SDL_SCANCODE_F10] = KEY_F10;
    mTranslateKeyMap[SDL_SCANCODE_F11] = KEY_F11;
    mTranslateKeyMap[SDL_SCANCODE_F12] = KEY_F12;
    mTranslateKeyMap[SDL_SCANCODE_EQUALS]   = static_cast<KEY>('=');
    mTranslateKeyMap[SDL_SCANCODE_COMMA]    = static_cast<KEY>(',');
    mTranslateKeyMap[SDL_SCANCODE_MINUS]    = static_cast<KEY>('-');
    mTranslateKeyMap[SDL_SCANCODE_PERIOD]   = static_cast<KEY>('.');
    mTranslateKeyMap[SDL_SCANCODE_GRAVE]    = static_cast<KEY>('`');
    mTranslateKeyMap[SDL_SCANCODE_SLASH]    = KEY_DIVIDE;
    mTranslateKeyMap[SDL_SCANCODE_SEMICOLON]= static_cast<KEY>(';');
    mTranslateKeyMap[SDL_SCANCODE_LEFTBRACKET]  = static_cast<KEY>('[');
    mTranslateKeyMap[SDL_SCANCODE_BACKSLASH]    = static_cast<KEY>('\\');
    mTranslateKeyMap[SDL_SCANCODE_RIGHTBRACKET] = static_cast<KEY>(']');
    mTranslateKeyMap[SDL_SCANCODE_APOSTROPHE]   = static_cast<KEY>('\'');
    ...
    // numpad map
    mTranslateNumpadMap[SDL_SCANCODE_KP_0] = KEY_PAD_INS;
    mTranslateNumpadMap[SDL_SCANCODE_KP_1] = KEY_PAD_END;
    mTranslateNumpadMap[SDL_SCANCODE_KP_2] = KEY_PAD_DOWN;
    mTranslateNumpadMap[SDL_SCANCODE_KP_3] = KEY_PAD_PGDN;
    mTranslateNumpadMap[SDL_SCANCODE_KP_4] = KEY_PAD_LEFT;
    mTranslateNumpadMap[SDL_SCANCODE_KP_5] = KEY_PAD_CENTER;
    mTranslateNumpadMap[SDL_SCANCODE_KP_6] = KEY_PAD_RIGHT;
    mTranslateNumpadMap[SDL_SCANCODE_KP_7] = KEY_PAD_HOME;
    mTranslateNumpadMap[SDL_SCANCODE_KP_8] = KEY_PAD_UP;
    mTranslateNumpadMap[SDL_SCANCODE_KP_9] = KEY_PAD_PGUP;
    mTranslateNumpadMap[SDL_SCANCODE_KP_PERIOD] = KEY_PAD_DEL;
...
U16 adjustNativekeyFromUnhandledMask(const U16 key, const MASK mask)
{
    // When NumLock is off, map keypad scancodes to navigation scancodes
    U16 rtn = key;
    if (!(mask & SDL_KMOD_NUM))
    {
        switch (key)
        {
            case SDL_SCANCODE_KP_PERIOD: rtn = SDL_SCANCODE_DELETE; break;
            case SDL_SCANCODE_KP_0:      rtn = SDL_SCANCODE_INSERT; break;
            case SDL_SCANCODE_KP_1:      rtn = SDL_SCANCODE_END; break;
            case SDL_SCANCODE_KP_2:      rtn = SDL_SCANCODE_DOWN; break;
            case SDL_SCANCODE_KP_3:      rtn = SDL_SCANCODE_PAGEDOWN; break;
            case SDL_SCANCODE_KP_4:      rtn = SDL_SCANCODE_LEFT; break;
            case SDL_SCANCODE_KP_6:      rtn = SDL_SCANCODE_RIGHT; break;
            case SDL_SCANCODE_KP_7:      rtn = SDL_SCANCODE_HOME; break;
            case SDL_SCANCODE_KP_8:      rtn = SDL_SCANCODE_UP; break;
            case SDL_SCANCODE_KP_9:      rtn = SDL_SCANCODE_PAGEUP; break;
        }
    }
    return rtn;
}
...
U32 LLKeyboardSDL::mapSDL2toWin( U32 aSymbol )
{
    ...
    if( mSDL2_to_Win.empty() )
    {
        ...
        mSDL2_to_Win[ SDLK_KP_PERIOD  ] = (U32)WindowsVK::LL_VK_OEM_PERIOD; // LL_VK_DECIMAL?
        ...
        mSDL2_to_Win[ SDLK_KP_0 ] = (U32)WindowsVK::LL_VK_NUMPAD0;
        mSDL2_to_Win[ SDLK_KP_1 ] = (U32)WindowsVK::LL_VK_NUMPAD1;
        mSDL2_to_Win[ SDLK_KP_2 ] = (U32)WindowsVK::LL_VK_NUMPAD2;
        mSDL2_to_Win[ SDLK_KP_3 ] = (U32)WindowsVK::LL_VK_NUMPAD3;
        mSDL2_to_Win[ SDLK_KP_4 ] = (U32)WindowsVK::LL_VK_NUMPAD4;
        mSDL2_to_Win[ SDLK_KP_5 ] = (U32)WindowsVK::LL_VK_NUMPAD5;
        mSDL2_to_Win[ SDLK_KP_6 ] = (U32)WindowsVK::LL_VK_NUMPAD6;
        mSDL2_to_Win[ SDLK_KP_7 ] = (U32)WindowsVK::LL_VK_NUMPAD7;
        mSDL2_to_Win[ SDLK_KP_8 ] = (U32)WindowsVK::LL_VK_NUMPAD8;
        mSDL2_to_Win[ SDLK_KP_9 ] = (U32)WindowsVK::LL_VK_NUMPAD9;
